...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__815855A",
    appName: "vue-unicloud-test",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const d = true, f = "mp-weixin", g = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.0.2"\n    ],\n    "debugPort": 64250,\n    "initialLaunchType": "remote",\n    "servePort": 64251,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), p = h('[{"provider":"aliyun","spaceName":"vue3-unicloud-test","spaceId":"518d1ba8-f41c-4993-af37-948a679778bc","clientSecret":"1o2SOPzUreHFv6qoKtDEdA==","endpoint":"https://api.bspapp.com"}]');
let y = "";
try {
  y = "__UNI__815855A";
} catch (e) {
